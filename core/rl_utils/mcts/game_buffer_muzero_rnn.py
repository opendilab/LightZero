...
from .mcts_ptree import MuZeroRNNMCTSPtree as MCTS_ptree
# cpp mcts
from core.rl_utils.mcts.ctree_muzero import cytree as ctree
from .mcts_ctree import MuZeroRNNMCTSCtree as MCTS_ctree
...
@BUFFER_REGISTRY.register('game_buffer_muzero_rnn')
