...
namespace tree {
    ...
    class CNode {
        public:
            ...
            CNode(float prior, int action_num, std::vector<CNode> *ptr_node_pool, std::vector<int> &legal_actions);
            ~CNode();
    ...
    class CRoots{
        public:
            ...
            CRoots(int root_num, int action_num, int pool_size, std::vector<int> &legal_actions);
            CRoots(int root_num, int action_num, int pool_size, std::vector<std::vector<int> > &legal_actions_list);
            ~CRoots();
            ...
            void prepare(float root_exploration_fraction, const std::vector<std::vector<float> > &noises, const std::vector<float> &value_prefixs, const std::vector<std::vector<float> > &policies, std::vector<int> &to_play);
            void prepare_no_noise(const std::vector<float> &value_prefixs, const std::vector<std::vector<float> > &policies);
            void prepare_no_noise(const std::vector<float> &value_prefixs, const std::vector<std::vector<float> > &policies, std::vector<int> &to_play);
            void clear();
