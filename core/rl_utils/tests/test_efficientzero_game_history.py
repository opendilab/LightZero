...
from core.rl_utils.mcts.ctree_efficientzero import ez_tree
...
def test_game_history(env_name):
    if env_name == 'PongNoFrameskip-v4':
        from core.rl_utils.mcts.mcts_ctree import EfficientZeroMCTSCtree as MCTS
        from core.model.efficientzero.efficientzero_model import EfficientZeroNet as Model
        from zoo.atari.config.pong_efficientzero_config import pong_efficientzero_config as config
    elif env_name == 'tictactoe':
        from core.rl_utils.mcts.mcts_ctree import MuZeroMCTSCtree as MCTS
        from core.model.muzero.muzero_model import MuZeroNet as Model
