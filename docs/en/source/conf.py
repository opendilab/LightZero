...
if os.environ.get('READTHEDOCS') == "True":
    ...
    if lang in ["zh"]:
        ...
        if os.path.exists("index_{}.rst".format(lang)):
            print("File exists: index_{}.rst".format(lang))
        else:
            print("File does not exist: index_{}.rst".format(lang))
...
latex_documents = [
    (master_doc, 'LightZero.tex', 'LightZero Documentation', 'bao', 'manual'),
]
...
man_pages = [(master_doc, 'LightZero', 'LightZero Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'LightZero', 'LightZero Documentation', author, 'LightZero',
