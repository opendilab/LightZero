...
def main(env_id: str = 'detective.z5', seed: int = 0, max_env_step: int = int(1e6)) -> None:
    ...
    num_simulations: int = 4        # Number of simulations
    ...
    main_config.exp_name = (
        f"data_lz/data_unizero_jericho_ppo_debug/bge-base-en-v1.5/{env_id}/uz_gpu_cen{collector_env_num}_rr{replay_ratio}_ftemp025_{env_id[:8]}_ms{max_steps}_ass-{action_space_size}_"
