...
def generate_configs(env_id_list, env_configurations, collector_env_num, n_episode, evaluator_env_num,
    ...
    configs = []
    # ===== only for debug =====
    exp_name_prefix = f'data_lz/data_unizero_jericho_mt_20250501/jericho_{len(env_id_list)}games_tbs{total_batch_size}-nlayer{num_layers}-rr{replay_ratio}_not-share-head_encoder-final-ln_seed{seed}/'
