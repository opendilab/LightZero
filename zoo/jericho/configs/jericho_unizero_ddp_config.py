...
def main(env_id='detective.z5', seed=0):
    ...
    # num_segments = 4
    # n_episode = 4
    # batch_size = int(64//8)  # TODO: for serve model
    # num_unroll_steps = 10
    ...
    num_segments = 2
    n_episode = 2
    # batch_size = int(16//8)  # TODO: for local model
    # batch_size = 4  # TODO: for each gpu
    batch_size = 8  # TODO: for each gpu
    num_unroll_steps = 10
    infer_context_length = 4
    ...
    # model_name = "/mnt/afs/zhangshenghan/.cache/huggingface/hub/models--google-bert--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594"
    # =========== TODO: only for debug  =========== 
    # collector_env_num = 2
    # num_segments = 2
    # n_episode = 2
    ...
    # replay_ratio = 0.05
    # embed_dim = 768
    # update_per_collect = 2 # NOTE: very important for ddp
    ...
    main_config.exp_name = f'data_unizero_detective_4gpu_{model_name}_20250102/{env_id[:8]}_ms{max_steps}_uz_nlayer{num_layers}_gsl{game_segment_length}_rr{replay_ratio}_Htrain{num_unroll_steps}-Hinfer{infer_context_length}_bs{batch_size}_seed{seed}'
...
if __name__ == "__main__":
    ...
    Overview:
        ...
        python -m torch.distributed.launch --nproc_per_node=4 ./zoo/jericho/configs/jericho_unizero_ddp_config.py
        torchrun --nproc_per_node=2 ./zoo/jericho/configs/jericho_unizero_ddp_config.py
