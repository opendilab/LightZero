...
def prepare_unizero(cfg, create_cfg, llm_cfg, seed, data_processor=None):
    ...
    return replay_buffer, tb_logger, policy, collector, evaluator, learner
    ...
    while True:
        ...
        if rank == 0:
            ...
            if cmd != "stop":
                ...
                logger.info(f"[Rank 0: World Model] [Iter {learner.train_iter}] Training...")
