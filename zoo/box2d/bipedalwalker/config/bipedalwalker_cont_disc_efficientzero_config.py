...
bipedalwalker_cont_disc_efficientzero_config = dict(
    exp_name=
    f'data_sampled_efficientzero/bipedalwalker_cont_disc_efficientzero_ns{num_simulations}_upc{update_per_collect}-mur{replay_ratio}_rr{reanalyze_ratio}_seed0',
    env=dict(
        stop_value=int(1e6),
