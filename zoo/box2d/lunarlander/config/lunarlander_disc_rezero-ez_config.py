...
lunarlander_muzero_config = dict(
    exp_name=f'data_rezero-collect-mcts_ctree/lunarlander_rezero-collect-mcts_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        main_config.exp_name = f'data_rezero_ctree_0129/lunarlander_rezero-ez-mcts_ns{main_config.policy.num_simulations}_upc{main_config.policy.update_per_collect}_rr{main_config.policy.reanalyze_ratio}_seed{seed}'
