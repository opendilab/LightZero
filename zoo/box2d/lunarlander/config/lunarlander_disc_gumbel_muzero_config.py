...
lunarlander_gumbel_muzero_config = dict(
    exp_name=f'data_gumbel_muzero/lunarlander_gumbel_muzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
...
lunarlander_gumbel_muzero_config = EasyDict(lunarlander_gumbel_muzero_config)
