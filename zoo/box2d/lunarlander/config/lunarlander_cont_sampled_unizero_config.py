...
lunarlander_cont_sampled_unizero_config = dict(
    exp_name=f'data_sampled_unizero_1016/lunarlander_cont_sampled_unizero_sigma05_ns{num_simulations}_upc{update_per_collect}-rr{replay_ratio}_rer{reanalyze_ratio}_H{num_unroll_steps}-infer{infer_context_length}_bs{batch_size}_{norm_type}_seed0',
    env=dict(
