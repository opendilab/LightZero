...
lunarlander_muzero_config = dict(
    exp_name=f'data_mz_ctree/lunarlander_muzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_adamw3e-3_sslw2_seed{seed}',
    env=dict(
        stop_value=int(1e6),
...
if __name__ == "__main__":
    ...
    if entry_type == "train_muzero":
        ...
        train_muzero_with_gym_env([main_config, create_config], seed=seed, max_env_step=max_env_step)
