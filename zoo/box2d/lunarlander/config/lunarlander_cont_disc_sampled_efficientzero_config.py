...
lunarlander_cont_disc_sampled_efficientzero_config = dict(
    exp_name=f'data_sampled_efficientzero/lunarlander_cont_disc_sampled_efficientzero_k{K}_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
