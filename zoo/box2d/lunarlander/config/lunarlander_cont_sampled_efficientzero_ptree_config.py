...
lunarlander_cont_disc_sampled_efficientzero_config = dict(
    exp_name=f'data_sez_ptree/lunarlander_cont_sampled_efficientzero_seed0_sub883_ghl200_halfmodel_k20_fs1_ftv1_ns{num_simulations}_upc{update_per_collect}_cdt_cc0_adam3e-3_mgn05',
    env=dict(
