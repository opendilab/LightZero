...
memory_xzero_config = dict(
    ...
    f'_eps-20k_seed{seed}_eval{evaluator_env_num}_train-with-episode_conleninit{32}-conlenrecur{32}clear_gamma1_nl6-nh8-emd768_phase3-fixed-colormap-bce_phase1-fixed-target-pos_random-target-color',
    ...
    policy=dict(
        ...
        model_path=None,
        # model_path='/mnt/afs/niuyazhe/code/LightZero/data_memory_visual_match_0410/visual_match_memlen-0_xzero_H16_ns50_upcNone-mur0.25_rr0_bs64_eps-20k_seed0_eval8_train-with-episode_conleninit32-conlenrecur32clear_gamma1_nl6-nh8-emd768_phase3-fixed-colormap-bce_phase1-fixed-target-pos_random-target-color_reclw10/ckpt/ckpt_best.pth.tar',
        # model_path='/mnt/afs/niuyazhe/code/LightZero/data_memory_visual_match_0410/visual_match_memlen-0_xzero_H16_ns50_upcNone-mur0.25_rr0_bs64_eps-20k_seed0_eval8_train-with-episode_conleninit32-conlenrecur32clear_gamma1_nl6-nh8-emd768_phase3-fixed-colormap-bce_phase1-fixed-target-pos_random-target-color/ckpt/ckpt_best.pth.tar',
