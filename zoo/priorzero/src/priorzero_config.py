    ...
    if exp_name is None:
        ...
        if llm_config.enable_rft:
            exp_name = (
                ...
                f"priorzero_{env_name}_{model_key}_train_{llm_config.train_mode_dict.mode}/"
            ...
            exp_name = (
                f"all_experiments/data_priorzero_latest/llm_frozen/priorzero_{env_name}_{model_key}_"
