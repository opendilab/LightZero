...
pendulum_disc_stochastic_muzero_config = dict(
    exp_name=f'data_efficientzero/pendulum_disc_stochastic_muzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
        env_id='Pendulum-v1',
        continuous=False,
...
pendulum_disc_stochastic_muzero_config = EasyDict(pendulum_disc_stochastic_muzero_config)
main_config = pendulum_disc_stochastic_muzero_config

pendulum_disc_stochastic_muzero_create_config = dict(
    env=dict(
...
pendulum_disc_stochastic_muzero_create_config = EasyDict(pendulum_disc_stochastic_muzero_create_config)
create_config = pendulum_disc_stochastic_muzero_create_config
