...
if __name__ == "__main__":
    ...
    # args.env = 'PongNoFrameskip-v4'        # Reactive environment with dense rewards
    # args.env = 'MsPacmanNoFrameskip-v4'    # Memory-planning environment with sparse rewards
    ...
    # args.env = 'SeaquestNoFrameskip-v4'    # Memory-planning environment with sparse rewards
    # args.env = 'ALE/Seaquest-v5'           # Memory-planning environment with sparse rewards
    # args.env = 'HeroNoFrameskip-v4'        # Memory-planning environment with sparse rewards
    # args.env = 'AlienNoFrameskip-v4'

    # Two representative environments outside of atari8
    # args.env = 'QbertNoFrameskip-v4'       # Memory-planning environment with sparse rewards
    # args.env = 'ALE/Qbert-v5'              # Memory-planning environment with sparse rewards
    # args.env = 'SpaceInvadersNoFrameskip-v4'  # Memory-planning environment with sparse rewards

    # Environments that already perform well
    # args.env = 'BoxingNoFrameskip-v4'      # Reactive environment with dense rewards
