...
breakout_muzero_config = dict(
    exp_name=f'data_mz_ctree/breakout_muzero_ns{num_simulations}_upc{update_per_collect}_seed0',
    env=dict(
...
breakout_muzero_config = EasyDict(breakout_muzero_config)
main_config = breakout_muzero_config

breakout_muzero_create_config = dict(
    env=dict(
...
breakout_muzero_create_config = EasyDict(breakout_muzero_create_config)
create_config = breakout_muzero_create_config
