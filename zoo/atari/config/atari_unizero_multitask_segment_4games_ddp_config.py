...
if __name__ == "__main__":
    ...
    Overview:
        ...
        NCCL_BLOCKING_WAIT=1 NCCL_ASYNC_ERROR_HANDLING=1 NCCL_TIMEOUT=3600 python -m torch.distributed.launch --nproc_per_node=4 ./zoo/atari/config/atari_unizero_multitask_segment_4games_ddp_config.py
        torchrun --nproc_per_node=2 ./zoo/atari/config/atari_unizero_multitask_segment_4games_ddp_config.py # todo
    ...
    from easydict import EasyDict
    with DDPContext():
        # main_config = lz_to_ddp_config(configs)
        # w = get_world_size()
