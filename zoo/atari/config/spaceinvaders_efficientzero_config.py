...
average_episode_length_when_converge = 1000  # env-specific
...
spaceinvaders_efficientzero_config = dict(
    exp_name=f'data_ez_ctree/spaceinvaders_efficientzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
        stop_value=int(1e6),
    ...
    policy=dict(
        ...
        model=dict(
            ...
            action_space_size=6,  # env-specific
...
main_config = spaceinvaders_efficientzero_config

spaceinvaders_efficientzero_create_config = dict(
    env=dict(
...
create_config = spaceinvaders_efficientzero_create_config
