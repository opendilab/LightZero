...
if __name__ == "__main__":
    ...
    from lzero.entry import train_unizero
    main_config.exp_name = f'data_unizero_efficiency_cprofile_300k/{env_id[:-14]}_stack1_unizero_upc{update_per_collect}-rr{replay_ratio}_H{num_unroll_steps}_bs{batch_size}_seed1_nlayer2_opt-hash_only-recur-load-dc_targevalue-cuda_opt-computeloss_opt-value-lst_opt-targetpolicy-nonrer_opt-kvcaching-update_kv-nocpu-v2'
    ...
    import cProfile
    cProfile.run(f"run({300000})", filename="pong_uz_cprofile_300k_envstep_s1", sort="cumulative")