...
def main(env_id='BoxingNoFrameskip-v4', seed=0):
    ...
    evaluator_env_num = 3
    num_simulations = 10 # Originally 10
    ...
    atari_unizero_config = dict(
        ...
        policy=dict(
            learn=dict(
                learner=dict(
                    hook=dict(save_ckpt_after_iter=1_000_000),
                ),
            ),
            model=dict(
                observation_shape=(3, 64, 64),
                ...
                world_model_cfg=dict(
                    ...
                    max_tokens=2 * num_unroll_steps,  # obs+action per step
                    context_length=2 * infer_context_length,  # for inference
                    device='cuda',
                    action_space_size=action_space_size,
                    ...
                    # ======================
                    attention='routing',
                    routing_num_clusters=None,  # defaults to sqrt(max_tokens)
                    ...
                    routing_context_window_size=None,
                    # ======================
                    # other world‐model options
                    # ======================
