...
atari_muzero_config = dict(
    ...
    exp_name=exp_name_prefix+f'{env_name[:-14]}_xzero-mt_stack1_envnum{collector_env_num}_H{num_unroll_steps}_ns{num_simulations}_upc{update_per_collect}-mur{model_update_ratio}_rr{reanalyze_ratio}_soft005_eps20k_embed768_nlayer2_seed0',
    env=dict(
        stop_value=int(1e6),
        env_name=env_name,
