...
def generate_configs(
    ...
    configs = []
    exp_name_prefix = (
        f'data_muzero_stack1_mt_8games_ddp_8gpu_1201/{len(env_id_list)}games_brf{buffer_reanalyze_freq}_channel64/'
        f'{len(env_id_list)}games_brf{buffer_reanalyze_freq}_1-encoder-{norm_type}-res2-channel64_gsl20_'
