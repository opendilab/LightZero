...
atari_muzero_config = dict(
    exp_name=f'data_lz/data_muzero_history_20250324/{env_id[:-14]}_muzero_HL{history_length}_useaug_final-LN_ns{num_simulations}_upc{update_per_collect}_rer{reanalyze_ratio}_stack1_seed0',
    env=dict(
        stop_value=int(1e6),
        env_id=env_id,
