...
sco acp jobs create --workspace-name=fb1861da-1c6c-42c7-87ed-e08d8b314a99 \
    ...
    --job-name="mz-H5-seg8-gsl20-brf1-10-rbs160-rr025-temp025-simnorm-longrun-$env-s$seed" \
