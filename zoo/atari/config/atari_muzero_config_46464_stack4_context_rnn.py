...
atari_muzero_rnn_config = EasyDict(atari_muzero_rnn_config)
main_config = atari_muzero_rnn_config

atari_muzero_rnn_create_config = dict(
    env=dict(
...
create_config = atari_muzero_rnn_create_config
