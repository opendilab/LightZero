...
atari_efficientzero_create_config = dict(
    ...
    policy=dict(
        type='efficientzero_v2',
        import_names=['lzero.policy.efficientzero_v2'],
    ),
)
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        main_config.exp_name = f'data_efficientzero_v2/{env_id[:-14]}_efficientzero_v2_stack4_H{num_unroll_steps}_seed{seed}'
