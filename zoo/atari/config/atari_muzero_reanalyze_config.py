...
def main(env_id, seed):
    ...
    main_config.exp_name = f'data_muzero_reanalyze_1009/{env_id[:-14]}/{env_id[:-14]}_mz_fixvaluebugV10_td5_brf{buffer_reanalyze_freq}-rbs{reanalyze_batch_size}-rp{reanalyze_partition}_numsegments-{num_segments}_gsl{game_segment_length}_rr{replay_ratio}_Htrain{num_unroll_steps}_bs{batch_size}_seed{seed}'
...
if __name__ == "__main__":
    ...
    args.env = 'CrazyClimberNoFrameskip-v4'
    args.seed = 2
