...
atari_efficientzero_config = dict(
    exp_name='data_ez_ctree/pong_efficientzero_seed0_lr0.2_ns50_ftv025_upc1000_sub883_dqnexpertdata',
    env=dict(
...
if __name__ == "__main__":
    ...
    serial_pipeline_muzero_expert_data(
        [main_config, create_config],
        seed=0,
        collect_model=dqn_collect_model,
