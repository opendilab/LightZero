...
atari_muzero_config = dict(
    exp_name=f'data_paper_learn-dynamics_atari-20-games_debug/{env_id[:-14]}_muzero_stack4_H{num_unroll_steps}_initconlen{context_length_init}_simnorm-cossim_adamw1e-4_analysis_dratio0025_seed0',
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        main_config.exp_name=f'data_paper_learn-dynamics_atari-20-games_0423/{env_id[:-14]}_muzero_stack4_H{num_unroll_steps}_initconlen{context_length_init}_simnorm-cossim_adamw1e-4_analysis_dratio0025_seed{seed}'
        from lzero.entry import train_muzero_context
