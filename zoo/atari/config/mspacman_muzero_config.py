...
mspacman_muzero_config = dict(
    exp_name=f'data_mz_ctree/mspacman_muzero_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_seed0',
    env=dict(
        stop_value=int(1e6),
...
mspacman_muzero_config = EasyDict(mspacman_muzero_config)
main_config = mspacman_muzero_config

mspacman_muzero_create_config = dict(
    env=dict(
...
mspacman_muzero_create_config = EasyDict(mspacman_muzero_create_config)
