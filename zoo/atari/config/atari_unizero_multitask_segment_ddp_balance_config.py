...
def generate_configs(env_id_list, action_space_size, collector_env_num, n_episode, evaluator_env_num,
    ...
    exp_name_prefix = f'data_unizero_atari_mt_balance_20250814/atari_{len(env_id_list)}games_balance-total-stage{curriculum_stage_num}_stage-50k-20k_vit-small-ln_trans-nlayer4-moe8_backbone-attn-mlp-lora_no-lora-scale_brf{buffer_reanalyze_freq}-rr025_collect25_lora64_not-share-head_seed{seed}/'
...
if __name__ == "__main__":
    ...
    Overview:
        ...
        python -m torch.distributed.launch --nproc_per_node=8 --master_port=29501 zoo/atari/config/atari_unizero_multitask_segment_ddp_balance_config.py 2>&1 | tee ./log/202507/uz_mt_nlayer4_atari8_balance-totalstage5_backbone_brf002_collect25_lora64-32.log
