...
# exp_name_prefix = 'data_debug_xzero_ctree_mt_stack1_pong-qbert-seaquest/'
exp_name_prefix = 'data_debug_xzero_ctree_mt_stack1_pong-qbert/'
...
atari_muzero_config = dict(
    ...
    policy=dict(
        task_id=0,
        model_path=None,
        # model_path='/mnt/afs/niuyazhe/code/LightZero/data_xzero_ctree_0113_k1/Pong_muzero_gpt_envnum8_ns50_upc1000-mur0.25_rr0_H5_bs32_stack1_contembdings_lsd1024_lr1e-4-gcv10-reconslossw005-minmax-jointtrain-true_mcs5e2_collectper200-clear_evalmax_seed0/ckpt/iteration_167000.pth.tar',
