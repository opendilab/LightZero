...
dmc2gym_sampled_efficientzero_config = dict(
    exp_name=f'data_sez_ctree/dmc2gym_sampled_efficientzero_k{K}_ns{num_simulations}_upc{update_per_collect}_seed0',
    env=dict(
    ...
    policy=dict(
        ...
        model=dict(
            # ==============================================================
            # We use the medium size model for dmc2gym.
            # ==============================================================
            # NOTE: the key difference setting between image-input and vector input.
            image_channel=1,
            frame_stack_num=1,
            downsample=False,
            observation_shape=(1, observation_dim, 1),  # if frame_stack_num=1
...
dmc2gym_sampled_efficientzero_config = EasyDict(dmc2gym_sampled_efficientzero_config)
main_config = dmc2gym_sampled_efficientzero_config

dmc2gym_sampled_efficientzero_create_config = dict(
    env=dict(
        type='dmc2gym',
...
dmc2gym_sampled_efficientzero_create_config = EasyDict(dmc2gym_sampled_efficientzero_create_config)
create_config = dmc2gym_sampled_efficientzero_create_config
