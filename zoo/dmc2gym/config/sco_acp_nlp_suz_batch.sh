...
sco acp jobs create --workspace-name=df42ac16-77cf-4cfe-a3ce-e89e317bdf20 \
    ...
    --job-name="suz-nlayer4-rr025-segcollect-origctree-density-H10-2-$env-s$seed" \
