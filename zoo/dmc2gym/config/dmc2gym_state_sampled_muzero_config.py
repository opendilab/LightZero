...
dmc2gym_state_cont_sampled_muzero_config = dict(
    exp_name=f'data_sampled_muzero_1021/originbuffer_1023_density/dmc2gym_{env_id}_state_cont_sampled_muzero_k{K}_ns{num_simulations}_upc{update_per_collect}-rr{replay_ratio}_rer{reanalyze_ratio}_{norm_type}_seed{seed}',
    env=dict(
        env_id='dmc2gym-v0',
