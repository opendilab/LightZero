...
if __name__ == "__main__":
    ...
    target_return_dict = {
        ...
        'cartpole-balance':900, # 1
        'cartpole-balance_sparse':950, # 2
        'cartpole-swingup': 750, # 3
        'cartpole-swingup_sparse': 750, # 4
        'cheetah-run': 550, # 5
        "ball_in_cup-catch": 950, # 6
        "finger-spin": 800, # 7 todo
        "finger-turn_easy": 950, # 8 波动
        "finger-turn_hard": 950,  # 9 波动
        'hopper-hop': 150,  # 10 bad 
        'hopper-stand': 600, # 11 TODO
        'pendulum-swingup': 800, # 12 bad TODO
        'reacher-easy': 900, # 13
        'reacher-hard': 900, # 14 波动
        'walker-run': 500, # 15 略差 TODO
        'walker-stand': 900, # 16
        'walker-walk': 900, # 17
    }
