...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "include_dirs": [
            "/private/var/folders/r5/znmp_3cn0_b41yvr2tvld9ys0qypks/T/pip-build-env-6l8r0sjs/overlay/lib/python3.8/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "zoo.board_games.tictactoe.envs.get_done_winner_cython",
        "sources": [
            "/Users/puyuan/code/LightZero/zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx"
        ]
    },
 ...
 */
  ...
  /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":21
 *     cdef int32_t i, j, player, x, y, count
 *     cdef bint has_legal_actions = False
 *     cdef directions = ((1, -1), (1, 0), (1, 1), (0, 1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":24
 * 
 * 
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         for j in range(3):
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":27
 *         for j in range(3):
 *             if board[i, j] == 0:
 *                 has_legal_actions = True             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      if (likely(PyList_CheckExact(__pyx_v_directions)) || PyTuple_CheckExact(__pyx_v_directions)) {
        __pyx_t_6 = __pyx_v_directions; __Pyx_INCREF(__pyx_t_6); __pyx_t_7 = 0;
        __pyx_t_8 = NULL;
      } else {
        __pyx_t_7 = -1; __pyx_t_6 = PyObject_GetIter(__pyx_v_directions); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 30, __pyx_L1_error)
      ...
      for (;;) {
        ...
        /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":31
 *             player = board[i, j]
 *             for d in directions:
 *                 x, y = i, j             # <<<<<<<<<<<<<<
 *                 count = 0
 ...
 */
        ...
        /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":33
 *                 x, y = i, j
 *                 count = 0
 *                 for _ in range(5):             # <<<<<<<<<<<<<<
 *                     if x < 0 or x >= 3 or y < 0 or y >= 3:
 ...
 */
        for (__pyx_t_12 = 0; __pyx_t_12 < 5; __pyx_t_12+=1) {
          ...
          /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":34
 *                 count = 0
 *                 for _ in range(5):
 *                     if x < 0 or x >= 3 or y < 0 or y >= 3:             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
          ...
          if (__pyx_t_5) {
            ...
            /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":35
 *                 for _ in range(5):
 *                     if x < 0 or x >= 3 or y < 0 or y >= 3:
 *                         break             # <<<<<<<<<<<<<<
 *                     if board[x, y] != player:
 ...
 */
          ...
          /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":36
 *                     if x < 0 or x >= 3 or y < 0 or y >= 3:
 *                         break
 *                     if board[x, y] != player:             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
          ...
          if (__pyx_t_5) {
            ...
            /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":37
 *                         break
 *                     if board[x, y] != player:
 *                         break             # <<<<<<<<<<<<<<
 *                     x += d[0]
 ...
 *                     count += 1
 */
          __pyx_t_9 = __Pyx_PyInt_From_int32_t(__pyx_v_x); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 38, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __pyx_t_14 = __Pyx_GetItemInt(__pyx_v_d, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 38, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_14);
          __pyx_t_15 = PyNumber_InPlaceAdd(__pyx_t_9, __pyx_t_14); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 38, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_15);
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
          __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          __pyx_t_11 = __Pyx_PyInt_As_int32_t(__pyx_t_15); if (unlikely((__pyx_t_11 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 *                     if count == 5:
 */
          __pyx_t_15 = __Pyx_PyInt_From_int32_t(__pyx_v_y); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_15);
          __pyx_t_14 = __Pyx_GetItemInt(__pyx_v_d, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_14);
          __pyx_t_9 = PyNumber_InPlaceAdd(__pyx_t_15, __pyx_t_14); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_9);
          __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
          __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          __pyx_t_11 = __Pyx_PyInt_As_int32_t(__pyx_t_9); if (unlikely((__pyx_t_11 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
          __pyx_v_y = __pyx_t_11;
 ...
 */
          ...
          if (__pyx_t_5) {
            ...
            /* "zoo/board_games/tictactoe/envs/get_done_winner_cython.pyx":42
 *                     count += 1
 *                     if count == 5:
 *                         return True, player             # <<<<<<<<<<<<<<
 *     return not has_legal_actions, -1
 */
            ...
            __pyx_t_9 = __Pyx_PyInt_From_int32_t(__pyx_v_player); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_9);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = __Pyx_PyBool_FromLong((!(__pyx_v_has_legal_actions != 0))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_int_1, __pyx_int_neg_1); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_int_1, __pyx_int_0); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__2);
  __Pyx_GIVEREF(__pyx_tuple__2);
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_int_1, __pyx_int_1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_tuple__4 = PyTuple_Pack(2, __pyx_int_0, __pyx_int_1); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__4);
  __Pyx_GIVEREF(__pyx_tuple__4);
  __pyx_tuple__5 = PyTuple_Pack(4, __pyx_tuple_, __pyx_tuple__2, __pyx_tuple__3, __pyx_tuple__4); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 21, __pyx_L1_error)
