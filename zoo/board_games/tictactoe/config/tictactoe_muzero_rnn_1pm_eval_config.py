...
tictactoe_muzero_rnn_config = dict(
    ...
    policy=dict(
        # model_path=None,
        model_path='/Users/puyuan/code/LightZero/data_mz_ctree/tictactoe_1pm_muzero_seed0_sub885_ghl5_ftv1_cc0_fs2_ns25_upc40_cdt_adam3e-3_mgn05/ckpt/ckpt_best.pth.tar',
        env_name='tictactoe',
