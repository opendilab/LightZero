...
tictactoe_muzero_config = dict(
    exp_name=
    f'data_mz_ctree/tictactoe_self-play_muzero_seed0_sub885_ghl9_ftv1_cc0_fs2_ns{num_simulations}_upc{update_per_collect}_cdt_adam3e-3_mgn05',
    env=dict(
    ...
    policy=dict(
        # model_path=None,
        model_path=
        '/Users/puyuan/code/LightZero/data_mz_ctree/tictactoe_self-play_muzero_seed0_sub885_ghl9_ftv1_cc0_fs2_ns25_upc100_cdt_adam3e-3_mgn05/ckpt/ckpt_best.pth.tar',
        env_name='tictactoe',
