...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/Users/puyuan/code/LightZero/zoo/board_games/gomoku/envs/get_done_winner_cython.pyx"
        ]
    },
...
/* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":7
...
static PyObject *__pyx_f_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(int32_t __pyx_v_board_size, __Pyx_memviewslice __pyx_v_board, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":24
 *     """
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":32
 *         for j in range(board_size):
 *             if board[i, j] == 0:
 *                 has_legal_actions = True             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":34
 *                 has_legal_actions = True
 *                 continue
 *             player = board[i, j]             # <<<<<<<<<<<<<<
 *             for d in directions:
 ...
 */
      ...
      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":35
 *                 continue
 *             player = board[i, j]
 *             for d in directions:             # <<<<<<<<<<<<<<
 *                 x, y = i, j
 ...
 */
      if (likely(PyList_CheckExact(__pyx_v_directions)) || PyTuple_CheckExact(__pyx_v_directions)) {
        __pyx_t_10 = __pyx_v_directions; __Pyx_INCREF(__pyx_t_10); __pyx_t_11 = 0;
        __pyx_t_12 = NULL;
      } else {
        __pyx_t_11 = -1; __pyx_t_10 = PyObject_GetIter(__pyx_v_directions); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
      ...
      for (;;) {
        ...
        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":36
 *             player = board[i, j]
 *             for d in directions:
 *                 x, y = i, j             # <<<<<<<<<<<<<<
 *                 count = 0
 ...
 */
        ...
        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":37
 *             for d in directions:
 *                 x, y = i, j
 *                 count = 0             # <<<<<<<<<<<<<<
 *                 for _ in range(5):
 ...
 */
        ...
        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":38
 *                 x, y = i, j
 *                 count = 0
 *                 for _ in range(5):             # <<<<<<<<<<<<<<
 *                     if x < 0 or x >= board_size or y < 0 or y >= board_size:
 ...
 */
        for (__pyx_t_16 = 0; __pyx_t_16 < 5; __pyx_t_16+=1) {
          ...
          /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":39
 *                 count = 0
 *                 for _ in range(5):
 *                     if x < 0 or x >= board_size or y < 0 or y >= board_size:             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
          ...
          __pyx_t_17 = ((__pyx_v_x >= __pyx_v_board_size) != 0);
          if (!__pyx_t_17) {
          } else {
            __pyx_t_9 = __pyx_t_17;
            goto __pyx_L13_bool_binop_done;
          ...
          __pyx_t_17 = ((__pyx_v_y >= __pyx_v_board_size) != 0);
          __pyx_t_9 = __pyx_t_17;
 ...
 *                     count += 1
 */
          __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_x); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_13);
          __pyx_t_18 = __Pyx_GetItemInt(__pyx_v_d, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_18);
          __pyx_t_19 = PyNumber_InPlaceAdd(__pyx_t_13, __pyx_t_18); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_19);
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
          __pyx_t_15 = __Pyx_PyInt_As_int32_t(__pyx_t_19); if (unlikely((__pyx_t_15 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
          __pyx_v_x = __pyx_t_15;

          /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":44
 *                         break
 *                     x += d[0]
 *                     y += d[1]             # <<<<<<<<<<<<<<
 *                     count += 1
 *                     if count == 5:
 */
          __pyx_t_19 = __Pyx_PyInt_From_int32_t(__pyx_v_y); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 44, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_19);
          __pyx_t_18 = __Pyx_GetItemInt(__pyx_v_d, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 44, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_18);
          __pyx_t_13 = PyNumber_InPlaceAdd(__pyx_t_19, __pyx_t_18); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 44, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_13);
          __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
          __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
          __pyx_t_15 = __Pyx_PyInt_As_int32_t(__pyx_t_13); if (unlikely((__pyx_t_15 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          __pyx_v_y = __pyx_t_15;
 ...
 */
          ...
          if (__pyx_t_9) {
            ...
            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":47
 *                     count += 1
 *                     if count == 5:
 *                         return True, player             # <<<<<<<<<<<<<<
 *     return not has_legal_actions, -1
 */
            ...
            __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_player); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 47, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_13);
            __pyx_t_18 = PyTuple_New(2); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 47, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_18);
 ...
 */
  ...
  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":48
 *                     if count == 5:
 *                         return True, player
 *     return not has_legal_actions, -1             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_10 = __Pyx_PyBool_FromLong((!(__pyx_v_has_legal_actions != 0))); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
...
static PyObject *__pyx_pw_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_1get_done_winner_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_done_winner_cython (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_board)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_done_winner_cython", 1, 2, 2, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_done_winner_cython") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_board_size = __Pyx_PyInt_As_int32_t(values[0]); if (unlikely((__pyx_v_board_size == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_board = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_int32_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_board.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_done_winner_cython", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("zoo.board_games.gomoku.envs.get_done_winner_cython.get_done_winner_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(CYTHON_UNUSED PyObject *__pyx_self, int32_t __pyx_v_board_size, __Pyx_memviewslice __pyx_v_board) {
  ...
  __Pyx_RefNannySetupContext("get_done_winner_cython", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_board.memview)) { __Pyx_RaiseUnboundLocalError("board"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(__pyx_v_board_size, __pyx_v_board, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 */
  ...
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_int_1, __pyx_int_1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 26, __pyx_L1_error)
  ...
  __pyx_tuple__5 = PyTuple_Pack(4, __pyx_tuple_, __pyx_tuple__2, __pyx_tuple__3, __pyx_tuple__4); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 26, __pyx_L1_error)
