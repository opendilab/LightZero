...
gomoku_muzero_config = dict(
    exp_name=
    f'data_mz_ctree/gomoku_bs6_vs-bot_ghl18_muzero_seed0_sub883_halfmodel_ftv1_cc0_fs1_cdt_adam3e-3_mgn05_ns{num_simulations}_upc{update_per_collect}_mis256_rr05_tt1e4',
    env=dict(
