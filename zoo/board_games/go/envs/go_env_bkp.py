...
class GoEnv(BaseEnv):
    ...
    def reset(self):
        ...
        # self._go = go.go_base.Position(board=None, komi=self._komi)
        # self._go = go.step(board=None, komi=self._komi)
        # self._go._overwrite_go_global_variables(board_size=self.board_size)
        # self._overwrite_go_global_variables(board_size=self.board_size)

        # self._go = go.env(board_size=self.board_size, komi=self._komi)
    ...
    def _overwrite_go_global_variables(self, board_size: int):
        ...
        # }
        # return
        self._go._overwrite_go_global_variables(board_size)
