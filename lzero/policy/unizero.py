...
class UniZeroPolicy(MuZeroPolicy):
    ...
    def _forward_learn(self, data: Tuple[torch.Tensor]) -> Dict[str, Union[float, int]]:
        ...
        return_log_dict = {
            ...
            'analysis/dormant_ratio_encoder': float(dormant_ratio_encoder),
            'analysis/dormant_ratio_transformer': float(dormant_ratio_transformer),
            'analysis/dormant_ratio_head': float(dormant_ratio_head),

            'analysis/avg_weight_mag_encoder': float(avg_weight_mag_encoder),
            'analysis/avg_weight_mag_transformer': float(avg_weight_mag_transformer),
            'analysis/avg_weight_mag_head': float(avg_weight_mag_head),
            'analysis/e_rank_last_linear': float(e_rank_last_linear),
            'analysis/e_rank_sim_norm': float(e_rank_sim_norm),
