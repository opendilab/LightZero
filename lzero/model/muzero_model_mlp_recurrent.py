...
from .common import MZRNetworkOutput, RepresentationNetworkMLP, PredictionNetworkMLP
from .utils import renormalize, get_params_mean, get_dynamic_mean, get_reward_mean


@MODEL_REGISTRY.register('MuZeroModelMLPR')
class MuZeroModelMLPR(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(MuZeroModelMLPR, self).__init__()
...
class DynamicsNetwork(nn.Module):
    ...
    def forward(self, state_action_encoding: torch.Tensor, dynamics_hidden_state) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        lstm_output, next_dynamics_hidden_state = self.lstm(next_latent_state_unsqueeze, dynamics_hidden_state)
        ...
        # the residual link: add the latent_state to the state_action encoding
        if self.res_connection_in_dynamics:
            next_latent_state = next_latent_state_encoding + latent_state
        else:
            next_latent_state = next_latent_state_encoding
