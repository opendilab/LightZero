...
class DynamicsNetwork(nn.Module):
    ...
    def __init__(
        ...
        Overview:
            ...
            reward and reward_hidden_state by the given current latent state and action.
        Arguments:
    ...
    def forward(self, state_action_encoding: torch.Tensor,
                dynamics_hidden_state: Tuple[torch.Tensor, torch.Tensor]) -> Tuple[torch.Tensor, Tuple, torch.Tensor]:
        """
        Overview:
        ...
        x = self.linear_common(x.reshape(-1, 64 * 8 * 8))
        ...
        if self.use_sim_norm:
            # NOTE: very important. for unizero atari 64,8,8 = 4096
