...
from lzero.model.efficientzero_model_mlp import EfficientZeroModelMLP, DynamicsNetworkMLP, PredictionNetworkMLP

@MODEL_REGISTRY.register('EfficientZeroModelStructure')
class EfficientZeroModelStructure(EfficientZeroModelMLP):
    def __init__(
            self,
            env_name: str,
        ...
        Arguments:
            - env_name (:obj:`str`): Env name, e.g. ptz_simple_spread, gobigger etc.
        ...
        """
        super(EfficientZeroModelStructure, self).__init__()
