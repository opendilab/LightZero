...
@MODEL_REGISTRY.register('GoBiggerSampledEfficientZeroModel')
class GoBiggerSampledEfficientZeroModel(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super(GoBiggerSampledEfficientZeroModel, self).__init__()
