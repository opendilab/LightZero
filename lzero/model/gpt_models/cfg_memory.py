...
cfg['world_model'] = {
                    ...
                    #   "max_tokens": 2 * 5,  # H=5
                      ...
                      # 'max_blocks': 16,
                      # "max_tokens": 2 * 16,  # 1+15 + memory_length = 0

                      'max_blocks': 17,
                      "max_tokens": 2 * 17,  # 1+15 + memory_length = 1

                      # 'max_blocks': 30,
                      # "max_tokens": 2 * 30,  # 15+15+ memory_length = 0
                    ...
                    #   "max_tokens": 2 * 530, 
                      ...
                      # "max_tokens": 2 * 1030, 
                        ...
                        'embed_dim': 96,  # TODO：for memory # 100 same as <Transformer shine in RL> paper
                      'group_size': 8,  # NOTE
