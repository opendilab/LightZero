...
def visualize_attention_map(model, input_embeddings: torch.Tensor, kv_cache: Optional[KeysValues] = None,
...
def visualize_attention_maps(model, input_embeddings: torch.Tensor, kv_cache: Optional[KeysValues] = None,
