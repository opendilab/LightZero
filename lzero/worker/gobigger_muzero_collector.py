...
class GoBiggerMuZeroCollector(ISerialCollector):
    ...
    def collect(self,
        ...
        while True:
            with self._timer:
                ...
                # stack_obs = {env_id: [game_segments[env_id][agent_id].get_obs() for agent_id in agent_num] for env_id in ready_env_id}
            ...
            for env_id, timestep in timesteps.items():
                ...
                if timestep.done:
                    ...
                    reward = timestep.info['eval_episode_return'][0]
                    info = {
                        'reward': reward,
    ...
    def _output_log(self, train_iter: int) -> None:
        ...
        if (train_iter - self._last_train_iter) >= self._collect_print_freq and len(self._episode_info) > 0:
            ...
            visit_entropy = [d['visit_entropy'][0] for d in self._episode_info]
