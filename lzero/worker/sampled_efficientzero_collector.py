...
from lzero.mcts.tree_search.game_sampled_efficientzero import GameHistory
...
class SampledEfficientZeroCollector(ISerialCollector):
    ...
    def __init__(
        ...
        """
        Overview:
            Init the SampledEfficientZero collector according to input arguments.
        Arguments:
    ...
    def collect(self,
        ...
        while True:
            with self._timer:
                ...
                root_sampled_actions_dict_no_env_id = {k: v['root_sampled_actions'] for k, v in policy_output.items()}
