            ...
            for env_id, timestep in timesteps.items():
                ...
                if timestep.done:
                    ...
                    if n_episode > self._env_num:
                        ...
                        observation_window_stack[env_id] = deque([init_obs for _ in range(self.policy_config.model.frame_stack_num)], maxlen=self.policy_config.model.frame_stack_num)
                        game_segments[env_id].reset(observation_window_stack[env_id])
