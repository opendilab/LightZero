...
from lzero.rl_utils import inverse_scalar_transform
...
def test_mcts():
    import lzero.rl_utils.mcts.ctree_sampled_efficientzero.cytree as ctree
    import numpy as np
    from lzero.rl_utils.mcts.mcts_ctree_sampled import SampledEfficientZeroMCTSCtree as MCTS
