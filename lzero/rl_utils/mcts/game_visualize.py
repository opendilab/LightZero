...
class GameHistory:
    ...
    def append(self, action, leaf_node, leaf_hidden_state, search_path, obs, reward, action_mask=None, to_play=None):
        """
        Overview:
        ...
        self.leaf_node_history.append(leaf_node)
        self.leaf_hidden_state_history.append(leaf_hidden_state)

        self.search_path_history.append(search_path)
    ...
    def game_history_to_array(self):
        ...
        self.leaf_node_history = np.array(self.leaf_node_history)
        self.leaf_hidden_state_history = np.array(self.leaf_hidden_state_history)
        self.search_path_history = np.array(self.search_path_history)
