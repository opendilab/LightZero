...
import lzero.mcts.tree.ptree_sampled_efficientzero as tree_sez
...
import lzero.mcts.tree.ptree_sampled_muzero as tree_smz
    ...
    def search(self, roots, model, hidden_state_roots, to_play=None):
        ...
        with torch.no_grad():
            ...
            for index_simulation in range(self.config.num_simulations):
                ...
                # prepare a result wrapper to transport results between python and c++ parts
                results = tree_smz.SearchResults(num=num)
