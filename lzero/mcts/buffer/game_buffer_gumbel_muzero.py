...
class GumbelMuZeroGameBuffer(GameBuffer):
    """
    Overview:
    ...
    def _make_batch(self, batch_size: int, reanalyze_ratio: float) -> Tuple[Any]:
        ...
        obs_list, action_list, new_policy_list, mask_list = [], [], [], []
        ...
        for i in range(batch_size):
            ...
            _new_policy = game.new_policy_probs[pos_in_game_segment:pos_in_game_segment + self._cfg.num_unroll_steps]
            if not isinstance(_new_policy, list):
                _new_policy = _new_policy.tolist()
            ...
            new_policy_list.append(_new_policy)
        ...
        current_batch = [obs_list, action_list, new_policy_list, mask_list, batch_index_list, weights_list, make_time_list]
